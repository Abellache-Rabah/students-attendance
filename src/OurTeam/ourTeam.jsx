...
<div className="container my-24 px-6 mx-auto col-start-2 col-end-5 overflow-y-scroll">
    ...
    <div className="grid md:grid-cols-3 gap-x-6 lg:gap-x-12">
      ...
      <div className="">
        <div className="bg-white block rounded-lg shadow-lg">
          ...
          <div className="p-6">
            <h5 className="text-lg font-bold mb-4">Masri Ahmed</h5>
            <p className="text-gray-500 mb-4">Computer scince stydent</p>
            <ul className="list-inside flex mx-auto justify-center">
              <a href="#!" className="px-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
